...
# Generate result summary as a dictionary
def generate_summary(result, student_name="Candidate", subject="Subject", set_number="Set"):
    summary = {
        ...
        "Score": f"{result['correct']} / {result['total_questions']}",
        "Details": result["details"]
    }
    return summary

# Generate PDF from result summary
def generate_pdf(summary, subject, set_number):
    buffer = BytesIO()
